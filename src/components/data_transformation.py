...
class DataTransformationConfig:
    preproccesor_obj_file_path = os.path.join('artifacts', "proprocesor.pkl")
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("reading train and test data successful")
            ...
            logging.info("Applying data transformation on train & test data")
